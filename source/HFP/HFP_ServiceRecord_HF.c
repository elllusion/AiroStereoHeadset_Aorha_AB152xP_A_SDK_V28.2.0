...
ATTRDEF_ROM(hsp, ServiceClassIdList) = 
			{ ATTRID(ATTRID_ServiceClassIdList), ATTRLEN(11), DEDEF_SEQU8(9), SERVICE_UUID16(SERVICE_UUID_HEADSET), SERVICE_UUID16(SERVICE_UUID_GENERIC_AUDIO), SERVICE_UUID16(SERVICE_UUID_HEADSET_HS) };
...
ATTRDEF_ROM(hsp, ServiceName) = 
			{ ATTRID(ATTRID_ServiceName), ATTRLEN(12), DEDEF_TEXT8(10), 'H', 'e', 'a', 'd', 's', 'e', 't', '-', 'H', 'S' };
...
ATTRDEF_ROM(hfp, ServiceClassIdList) = 
			{ ATTRID(ATTRID_ServiceClassIdList), ATTRLEN(8), DEDEF_SEQU8(6), SERVICE_UUID16(SERVICE_UUID_HANDSFREE), SERVICE_UUID16(SERVICE_UUID_GENERIC_AUDIO) };
...
ATTRDEF_ROM(hfp, ServiceName) = 
			{ ATTRID(ATTRID_ServiceName), ATTRLEN(17), DEDEF_TEXT8(15), 'H', 'a', 'n', 'd', 's', '-', 'F', 'r', 'e', 'e', ' ', 'u', 'n', 'i', 't' };
