...
{
	{
			...
			{ //productType
				...
				PRODUCT_VER_TWS << 4 | PRODUCT_AIR_SCO_WOOFER, //pnpProductVersion
			},
			{ //airPara
			...
			{//Evt Table
				...
				{
					MEDIA_EVT_MUTE_REMINDER, LED_INVALID, INVALID_BEEP_PATTERN, VOICE_PROMPT_INVALID, 0
				},
				{
					MEDIA_EVT_KEY_MIC_MUTE_ON, LED_INVALID, INVALID_BEEP_PATTERN, VOICE_PROMPT_INVALID, 0
				},
				{
					MEDIA_EVT_KEY_MIC_MUTE_OFF, LED_INVALID, INVALID_BEEP_PATTERN, VOICE_PROMPT_INVALID, 0
				},
				{
