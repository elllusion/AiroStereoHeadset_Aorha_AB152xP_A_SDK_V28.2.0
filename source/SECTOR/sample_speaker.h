...
{
	{
			...
			{//KeypadGpioCtl
				...
				0x01, 0x02, 0x03, 0x06, 0x07, 0x08, 0x09, 0x0b, 0x0a,  0x000007CE
				...
				#elif defined (AB1520SC)
				    #ifdef SELFIE_App
				        0x00, 0x02, 0x03, 0x01, 0x05, 0x04, 0x00, 0x00, 0x00,  0x0000003E //-ice
				    #else
			...
			},
			{
				...
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF}, {3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
				{3, 3, 3, 0xFF, 9, 0, 9, 0xFF, 9, 0, 9, 0xFF},
			},
			{
			...
			{ //batteryPara
				...
				20, //Low Battery Ring Timer
				{
					...
					180, //U16 tempDetectorSleepTime; //unit:0.5 s
				},
			},
			{//Timers
				#ifdef AIR_UPDATE_DONGLE
					0,			//AutoSwitchOffTimer: 1s
				#else
				...
				#ifdef AIR_UPDATE_DONGLE
					0,		//U8 AutoSwitchOffInLowBatTimer unit: 1min
				#else
				...
				0,		//U8 twsRelayDropPacketTimeout;//unit: 10ms
				30,		//U8 twsRelayNeedSwitchTimeout;//unit: 0.1S
				0,		//U8 reserved4;
			...
			{//Evt Table
				...
				{//Note: do not insert media event between MEDIA_EVT_KEY_TEST_VOICE_PROMPT_PLAY and MEDIA_EVT_KEY_TEST_VOICE_PROMPT_NEXT
					MEDIA_EVT_KEY_TEST_VOICE_PROMPT_PLAY, LED_INVALID, INVALID_BEEP_PATTERN, VOICE_PROMPT_INVALID, 0
				},
				{//Note: do not insert media event between MEDIA_EVT_KEY_TEST_VOICE_PROMPT_PLAY and MEDIA_EVT_KEY_TEST_VOICE_PROMPT_NEXT
			...
			{	//mmiAvrcpSettings
				...
				MMI_AVRCP_VOLUME_CHANGED, //notifyEventMask
				#else
